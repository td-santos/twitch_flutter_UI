...
class CardAoVivoTab extends StatelessWidget {
  ...
  const CardAoVivoTab({Key key, this.nomeCanal, this.urlCanal, this.descricaoLive, this.game, this.language, this.viewers, this.urlImageLive}) : super(key: key);
